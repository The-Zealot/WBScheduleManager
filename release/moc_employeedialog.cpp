...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_EmployeeDialog_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_EmployeeDialog_t qt_meta_stringdata_EmployeeDialog = {
    {
QT_MOC_LITERAL(0, 14) // "EmployeeDialog"
...
const QMetaObject EmployeeDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_EmployeeDialog.offsetsAndSize,
