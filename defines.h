...
#define DB_TABLE_POINTS_EMPLOYEE1   3
#define DB_TABLE_POINTS_EMPLOYEE2   4
#define DB_TABLE_POINTS_OPEN_DATE   5
#define DB_TABLE_POINTS_START_DATE  6
#define DB_TABLE_POINTS_LAST_PAYDAY 7
#define DB_TABLE_POINTS_SCHEDULE    8
